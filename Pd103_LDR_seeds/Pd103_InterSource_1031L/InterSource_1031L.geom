...
:start geometry definition:
    ...
    :start geometry:
        ...
        :start layer:
			...
			# Habib note: The dimension are corrected based on Meigooni and TG43U1S2 (In previous simulation, total source length was 0.513cm , while here is 0.45 cm)
            top radii    = 0.025 0.033
            bottom radii = 0.025 0.033
            media        = WATER_0.998 Ti   # first run for radial dose and anisotropy function
			# AIR_TG43 Ti   # sec run for Sk and DRC calculations
        :stop layer:
