...
:start geometry definition:
        #### Habib Note: The CS10 and CT10 from CivaTech tech Inc are identical, except the CT10 has smaller outer diameter OD=0.06 cm
    :start geometry:
        name = Thin
        library = egs_rz
        radii = 0.03
    ...
    :start geometry:
        ...
        :start media input:
			...
			# Habib It supposed that each Pd region is filled with 5% natural pd and 95% organic polymer # My result show 5% is the correct one {rho = 1.15, elements = H, C, N, O, PD ; mass fractions = 0.08075, 0.6156, 0.0475, 0.20615, 0.05} respectively
